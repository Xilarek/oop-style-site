...
window.addEventListener('DOMContentLoaded', function () {
  ...
  modulesSlider.init();
  var feeddSlider = new _modules_slider_slider_mini__WEBPACK_IMPORTED_MODULE_1__["default"]({
...
function () {
  ...
  _createClass(Difference, [{
    key: "bindTreggers",
    value: function bindTreggers(container, containerItems, counter) {
...
function (_Slider) {
  ...
  _createClass(MainSlider, [{
    ...
    key: "bindTriggers",
    value: function bindTriggers(btn) {
      var _this2 = this;
      ...
      btn.forEach(function (item) {
        item.addEventListener('click', function (e) {
          ...
          if (btn === _this2.prevmodule) {
            _this2.plusSlides(-1);
          } else if (btn === _this2.nextmodule) {
            _this2.plusSlides(1);
          }
        });
      });
